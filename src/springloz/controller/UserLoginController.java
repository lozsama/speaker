...
public class UserLoginController {
	...
	public String insertUserLogin(@RequestBody UserLogin userLogin) {
    	...
    	try {    		
    		...
    		if(logString==null )
    		{
    			...
    			List<UserLogin> listlogin2=userService.selsctUserCodeLoginCheck(Login);	
    			
    			SessionHolder.removeAttribute("uid");
    			
    			SessionHolder.setAttribute("uid", listlogin2.get(0).getUid());  
	...
	@ResponseBody
	public  List<UserLogin> handleException(MaxUploadSizeExceededException ex) throws Exception {     
